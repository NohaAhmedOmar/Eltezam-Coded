    ...
    public class DropDownsController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetGenderDropDown()
        {
            var data =await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==1);
            return Ok(data);
        }  
        ...
        {
            var data =await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==2);
            return Ok(data);
        } 
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==3);
            return Ok(data);
        }
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==4);
            return Ok(data);
        } 
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==5);
            return Ok(data);
        } 
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==10);
            return Ok(data);
        } 
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==11);
            return Ok(data);
        } 
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==6);
            return Ok(data);
        }
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==7);
            return Ok(data);
        }
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==8);
            return Ok(data);
        } 
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Enum>(x => new { Id = x.EnumId, Value = x.EnumValue },x=>x.CategoryId==9);
            return Ok(data);
        } 
        ...
        {
            var data = await dropDownService
                .GetDropDown<DomainModels.Code>(x => new { Id = x.Code1, Value = x.Value },x=>x.CategoryId==2);
            return Ok(data);
        } 

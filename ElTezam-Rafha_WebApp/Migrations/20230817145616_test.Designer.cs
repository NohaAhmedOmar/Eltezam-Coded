...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElTezam_Coded_WebApp.DomainModels.CodeTemp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElTezam_Coded_WebApp.DomainModels.Employee", b =>
                {
                    ...
                    b.Property<int?>("EnumId1")
                        .HasColumnType("int");

                    b.Property<int?>("EnumId2")
                        .HasColumnType("int");

                    b.Property<int?>("EnumId3")
                        .HasColumnType("int");

                    b.Property<int?>("EnumId4")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElTezam_Coded_WebApp.DomainModels.EmployeePayment", b =>
                {
                    ...
                    b.Property<string>("ConsolidationSetCode1")
                        .IsRequired()
                        .HasColumnType("nvarchar(25)");
                    ...
                    b.Property<string>("ElementCodeNavigationCode1")
                        .IsRequired()
                        .HasColumnType("nvarchar(25)");
                    ...
                    b.HasIndex("ConsolidationSetCode1");

                    b.HasIndex("ElementCodeNavigationCode1");
            ...
            modelBuilder.Entity("ElTezam_Coded_WebApp.DomainModels.EmployeePayment", b =>
                {
                    b.HasOne("ElTezam_Coded_WebApp.DomainModels.Code", "ConsolidationSet")
                        .WithMany()
                        .HasForeignKey("ConsolidationSetCode1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ElTezam_Coded_WebApp.DomainModels.Code", "ElementCodeNavigation")
                        .WithMany()
                        .HasForeignKey("ElementCodeNavigationCode1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

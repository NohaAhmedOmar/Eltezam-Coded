...
namespace ElTezam_Coded_WebApp.Migrations
{
    ...
    [Migration("20230708162348_Tbjob")]
    partial class Tbjob
    {
            ...
            modelBuilder.Entity("ElTezam_Coded_WebApp.DomainModels.Job", b =>
                {
                    ...
                    b.Property<string>("EmploymentTypeCodeNavigationCode1")
                        .IsRequired()
                        .HasColumnType("nvarchar(25)");
                    ...
                    b.Property<string>("JobNameCodeNavigationCode1")
                        .IsRequired()
                        .HasColumnType("nvarchar(25)");
                    ...
                    b.Property<string>("RankCodeNavigationCode1")
                        .IsRequired()
                        .HasColumnType("nvarchar(25)");
                    ...
                    b.HasIndex("EmploymentTypeCodeNavigationCode1");

                    b.HasIndex("JobNameCodeNavigationCode1");

                    b.HasIndex("RankCodeNavigationCode1");
            ...
            modelBuilder.Entity("ElTezam_Coded_WebApp.DomainModels.Job", b =>
                {
                    ...
                    b.HasOne("ElTezam_Coded_WebApp.DomainModels.Code", "EmploymentTypeCodeNavigation")
                        .WithMany()
                        .HasForeignKey("EmploymentTypeCodeNavigationCode1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ElTezam_Coded_WebApp.DomainModels.Code", "JobNameCodeNavigation")
                        .WithMany()
                        .HasForeignKey("JobNameCodeNavigationCode1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ElTezam_Coded_WebApp.DomainModels.Code", "RankCodeNavigation")
                        .WithMany()
                        .HasForeignKey("RankCodeNavigationCode1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
